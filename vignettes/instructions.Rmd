---
title: "rSWHAP: Package for Significant Wave Height Analysis and Prediction"
author: "Hugo L. Hammer, Tor Arne Oigard, Thordis Thorarinsdottir and Hanne Rognebakke"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to rSWAP}
...
These dependencies will be automatically installed when installing the rSWAP package.

The most recent version of the *rSWAP* package is hosted on a git repository at
<https://github.com/NorskRegnesentral/rSWAP.git>.

In order to install the rSWAP package run the following command:

```{r eval = FALSE}
devtools::install_github("NorskRegnesentral/rSWAP", build_vignettes = TRUE)
```
